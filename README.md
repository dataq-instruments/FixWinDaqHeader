...
Before downloading this utility, try [WinDaq Direct](https://www.dataq.com/products/windaq/indexwwb.html), its browser-based WWB will fix all the header errors listed below automatically, and it can play back WinDaq (wdh, wdq, whc, wdc) and Graphtec (gbd) data files on any modern computer/tablet/phone, iOS, macOS, Windows, ChromeOS, Linux, Android.
