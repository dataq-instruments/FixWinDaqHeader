...
Download fix_windaq.exe and save it to a folder on your harderive
...
This will generate a repaired file named SAMPLE_modified.WDQ. You can try the other corrupted Windaq files in the same GitHub folder
